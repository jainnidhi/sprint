...
function sprint_customize_register($wp_customize) {
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sprint_color_scheme',
        array(
            'label' => 'Primary Color',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sprint_theme_link_color',
        array(
            'label' => 'Link Color',
            'section' => 'sprint_theme_style_settings',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sprint_theme_linkhover_color',
        array(
    ...
    $wp_customize->add_setting('sprint_layout', 
            array( 
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sprint_bg_color',
        array(
    ...
    $wp_customize->add_setting('sprint_footer_footer_text', array(
        'default' => '',
        'sanitize_callback' => 'sanitize_text_field',
        'sanitize_js_callback' => 'sprint_sanitize_escaping',
    ));
    
    $wp_customize->add_control(new sprint_customize_textarea_control($wp_customize, 'sprint_footer_footer_text', array(
        'section' => 'sprint_footer', // id of section to which the setting belongs
        'settings' => 'sprint_footer_footer_text',
    )));
