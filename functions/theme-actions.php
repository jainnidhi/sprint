...
?>
<?php if (get_theme_mod('sprint_favicon') != ''){ ?>
	<link rel="icon" href="<?php echo get_theme_mod('sprint_favicon'); ?>" type="image/x-icon" />
<?php } ?>
...
if ( ! function_exists( 'sprint_head' ) ){
	...
	global $sprint_options
?>
<?php echo get_theme_mod('sprint_header_code'); ?>
<?php }
}
...
<div class="row" id="copyright-note">
	<?php if (get_theme_mod('sprint_footer_logo') != '') { ?>
		<div class="foot-logo">
			<a href="<?php echo home_url(); ?>" rel="nofollow"><img src="<?php echo get_theme_mod('sprint_footer_logo'); ?>" alt="<?php bloginfo( 'name' ); ?>"></a>
		</div>
	<?php } ?>
...
<div class="copyright-text"><?php echo get_theme_mod('sprint_copyrights'); ?></div>
