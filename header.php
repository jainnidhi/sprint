		...
		<?php if(get_theme_mod('sprint_featured_slider') == '1' && get_theme_mod('sprint_featured_slider') != '') { ?>
			<?php if(is_home() && !is_paged()) { ?>
				<div class="featuredBox">
					<?php $i = 1; $slider_cat = 1; if(get_theme_mod('sprint_featured_slider_cat') != '') { $slider_cat =(get_theme_mod('sprint_featured_slider_cat')); } $my_query = new WP_Query('cat='.$slider_cat.'&posts_per_page=4&ignore_sticky_posts=1'); 
